...
<section class="py-5">
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-md-6">
                ...
                <p style="font-size: 1.1rem; line-height: 1.8; color: #333;">
                    Faça parte da equipe Medeiros Supermercado! Estamos sempre em busca de profissionais dedicados e talentosos.
                </p>
                @auth
            ...
            <div class="col-md-6 text-center">
                <img src="/images/trabalhe-conosco.jpg" alt="Trabalhe Conosco" class="img-fluid" style="border-radius: 1rem; max-width: 25rem;" onerror="this.style.display='none'">
            </div>
        </div>
        ...
        <div class="text-center py-5">
            <h4 style="color: #666;">Sem vagas abertas no momento.</h4>
            <p style="color: #999;">Cadastre seu currículo e entraremos em contato quando houver oportunidades.</p>
        </div>
        @endif
    </div>
</section>
